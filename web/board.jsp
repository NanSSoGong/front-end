...
<%-- top menu --%>
<header>
    <a href="main.jsp" class="home-box image"><img src="image/outline-home-24px.svg" class="home-button"></a>
...
<main>
    <div id="listName1" class="list sortable">
        ...
        <img src="image/baseline-add_circle_outline-24px.svg" class="add-card-button">
    </div>
